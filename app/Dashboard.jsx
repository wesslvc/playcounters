      ...
      <header>
        ...
        {isEst(s) && (
          <p className="estnote">
            ...
            <b>Recap이 분 단위를 알려 준 곡만 그만큼 되살렸습니다.</b> 나머지
            곡의 재생 횟수는 기록 그대로입니다 — 그 곡들도 실제보다 적게
            잡혔지만, 얼마나 적은지 잴 방법이 없습니다. 들은 시간은 Recap
            총합에 맞춰 전부 같은 비율로 조정됩니다.
            기록 그대로 보려면 아래에서 바꿀 수 있습니다.
          </p>
        )}
      </header>
