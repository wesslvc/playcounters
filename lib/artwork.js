 ...
 * candidates are checked against both the artist and the title; the qualified
 * query already constrained the artist, and re-checking there rejects credit
 * spellings we can't model, so it verifies the title alone.
 *
