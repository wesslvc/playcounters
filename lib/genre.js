 ...
 * Genre → color.
 *
 * Genres arrive as a handful of coarse names from Deezer ("Rap/Hip Hop",
 * "Asian Music", "Soul & Funk"). Each is folded into a family, and the family
 * fixes the hue. Two K-pop tracks come out two neighbouring pinks; a rock track
 * is unmistakably elsewhere on the wheel.
 *
...
const FAMILIES = {
  ...
  latin:      { label: '라틴 · 월드',     hue: 132, sat: 50 },
  ...
  asian:      { label: '아시아 음악',     hue: 352, sat: 60 },
